...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        protected void OnEnable()
        {
            ...
            m_LocalizedWaitingPromptProperty = serializedObject.FindProperty("m_LocalizedWaitingPrompt");
            m_LocalizedWaitingWithControlPromptProperty = serializedObject.FindProperty("m_LocalizedWaitingWithControlPrompt");
            m_LocalizedTimeoutDescriptionProperty = serializedObject.FindProperty("m_LocalizedTimeoutDescription");
            m_LocalizedFallbackWaitingTextProperty = serializedObject.FindProperty("m_LocalizedFallbackWaitingText");
            m_LocalizedBindingPartPrefixProperty = serializedObject.FindProperty("m_LocalizedBindingPartPrefix");
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Localization Strings section.
            EditorGUILayout.Space();
            EditorGUILayout.LabelField(m_LocalizationLabel);
            using (new EditorGUI.IndentLevelScope())
            {
                EditorGUILayout.PropertyField(m_LocalizedWaitingPromptProperty);
                EditorGUILayout.PropertyField(m_LocalizedWaitingWithControlPromptProperty);
                EditorGUILayout.PropertyField(m_LocalizedTimeoutDescriptionProperty);
                EditorGUILayout.PropertyField(m_LocalizedFallbackWaitingTextProperty);
                EditorGUILayout.PropertyField(m_LocalizedBindingPartPrefixProperty);
            }
        ...
        // Localization Backing Serialized Properties
        private SerializedProperty m_LocalizedWaitingPromptProperty;
        private SerializedProperty m_LocalizedWaitingWithControlPromptProperty;
        private SerializedProperty m_LocalizedTimeoutDescriptionProperty;
        private SerializedProperty m_LocalizedFallbackWaitingTextProperty;
        private SerializedProperty m_LocalizedBindingPartPrefixProperty;

        private GUIContent m_UILabel = new GUIContent("UI");
        private GUIContent m_RebindOptionsLabel = new GUIContent("Rebind Options");
        private GUIContent m_LocalizationLabel = new GUIContent("Localization Strings");
